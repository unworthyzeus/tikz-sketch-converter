  ...
  plotStatistical: {
    ...
    sections: [
      ...
      },
      {
        ...
        fields: ['markStyle', 'plotSmooth', 'errorBarOptions', 'dataTable', 'addplotExtraOptions'],
      },
    ],
  },
  genericPlot: {
    ...
    sections: [
      ...
      },
      {
        id: 'plotTrace',
        title: 'Plot trace',
        fields: ['plotDomain', 'samples', 'markStyle', 'plotSmooth', 'axisEqual', 'colormap', 'axisExtraOptions', 'addplotExtraOptions'],
      },
    ],
  },
  opampComposite: {
